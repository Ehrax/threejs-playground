...
<div class="modal">
  <div class="modal-box w-11/12 max-w-3xl w-full h-full">
    <label class="btn btn-sm btn-circle absolute right-2 top-2" on:click={() => modal.closeModal()}>
      ✕
    </label>
    {#if $modal}
      <article class="prose">
        <SvelteMarkdown class="modal-content" source={$modal}/>
      </article>
    {/if}
  </div>
</div>
...
<div class="drawer">
  ...
  <div class="drawer-content">
    <label class="menu-button" on:click={() => toggleMenuDrawer()}>
  ...
  <div class="drawer-side">
    <label class="drawer-overlay" on:click={() => toggleMenuDrawer()}/>
