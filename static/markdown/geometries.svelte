# [Geometries](https://threejs-journey.com/lessons/9#what-is-a-geometry)
## What is a geometry?
...
We use geometries to create meshes, but you can also use geometries to form particles. Each vertex (singular of vertices) will correspond to a particle.
